/****************************************************
 * Executable: BinarySearchTree_double_driver
 * Author: Douglas Wilhelm Harder
 * Copyright (c) 2006-9 by Douglas Wilhelm Harder.  All rights reserved.
 *
 * DO NOT EDIT THIS FILE
 *
 * Create an instance of the Quadtree_tester<double> class
...
#include <iostream>
#include "BinarySearchTree_tester.h"

int main() {
	BinarySearchTree_tester<double> tester;
